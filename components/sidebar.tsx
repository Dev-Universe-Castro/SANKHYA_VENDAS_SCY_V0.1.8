  ...
  const menuItems = [
    ...
    ...(currentUser?.role === "Administrador"
      ? [
          ...
          { href: "/dashboard/sincronizacao-cabecalho-nota", label: "Sinc. Cabeçalho Nota", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-financeiro", label: "Sinc. Financeiro", icon: RefreshCw },
